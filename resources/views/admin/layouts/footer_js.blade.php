...
<script src="{{asset('libs/bootstrap-switch/dist/js/bootstrap-switch.min.js')}}" type="text/javascript"></script>
<!-- END CORE PLUGINS -->
...
<script src="{{asset('libs/amcharts/amcharts/radar.js')}}" type="text/javascript"></script>
